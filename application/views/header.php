          ...
          <div class="col-lg-12 col-md-12">
            <div class="logo">
              <a href="<?php echo site_url(); ?>">
                <h1 style="font-size:30px;">SISTEMA MEDIDOR DE ESTADOS DEL SUELO</h1>
              </a>
            </div>
          </div>
        </div>
            ...
            <div class="navbar-nav mr-auto">
              ...
              <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                  <a href="<?php echo site_url('MapsApi/gestionLugares'); ?>" class="dropdown-item">
              ...
              <a href="<?php echo site_url(); ?>/reportes/index" id="reportes" class="nav-item nav-link"><i class="far fa-clipboard"></i>&nbsp;&nbsp;REPORTES DE SUELOS - UTC -&nbsp;&nbsp;</a>

              <a href="<?php echo site_url(); ?>/mapsapi/index" id="geolocalizacion" class="nav-item nav-link"><i class="fa fa-object-group"></i>&nbsp;&nbsp;GEO - LOCALIZACIÓN&nbsp;&nbsp;</a>
